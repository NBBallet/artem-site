...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  icareMission1932En: "Igor Markevich composes L'Envol d'Icare in Paris. Written for Diaghilev's company. Diaghilev died in 1929 — the premiere was postponed indefinitely.", icareMission1932Uk: "Ігор Маркевич написав «Політ Ікара» в Парижі для трупи Дягілєва. Дягілєв помер у 1929-му — прем'єра відтерміновується назавжди.",
  ...
  humansMythBodyFr: "Les Parents cosmiques apparaissent. Leurs corps rejouent un rituel ancien : l'éveil de la matière, le façonnement de la forme, l'allumage de la conscience. De leurs mouvements naît l'être humain — incomplet, dépendant, terrifié, mais débordant d'un potentiel inexploité. Puis les créateurs s'en vont, regagnant leur monde d'origine. L'être créé reste seul sur Terre, pour découvrir le langage, établir des règles et bâtir une civilisation à partir de rien.",
  humansVideo1Id: "",
