...
export const DEFAULT_SETTINGS: SiteSettings = {
  ...
  animaBlockquoteFr:
    "Le Héros se met en harmonie à travers les arcanes majeurs du Tarot. L'Âme du Héros est un personnage à part entière, qui apparaît dans l'avant-dernière scène comme le fruit de toutes les transformations.",
  animaPoster1: "",
  animaPoster2: "",
  animaPoster3: "",
  animaPoster4: "",
  ...
  firebirdRefLabelFr: "Actualité · Référence",
  ...
  adiosTitleUk: "Адьос",
  adiosTitleFr: "Adios",
  adiosSubtitleEn: "Contemporary piece · 1st Place, International Choreographers’ Competition, Lviv",
  adiosSubtitleUk: "Сучасна постановка · 1 місце, Міжнародний конкурс балетмейстерів, Львів",
  adiosSubtitleFr: "Pièce contemporaine · 1re place, Concours international de chorégraphie, Lviv",
  adiosDescriptionEn: "A ballet quartet steeped in longing and farewell, set to the song of the same name by Benjamin Clementine from his Mercury Prize-winning debut album At Least for Now.\n\n1st Place at the International Choreographers’ Competition, Lviv, Ukraine, 2015.",
  adiosDescriptionUk: "Балетний квартет, насичений тугою та прощанням, — на однойменну пісню Бенджаміна Клементайна з альбому At Least for Now, що отримав Mercury Prize.\n\n1 місце на Міжнародному конкурсі балетмейстерів, Львів, Україна, 2015.",
  adiosDescriptionFr: "Un quatuor de ballet empreint de nostalgie et d'adieu, sur la chanson éponyme de Benjamin Clementine, tirée de son premier album At Least for Now, lauréat du Mercury Prize.\n\n1re place au Concours international de chorégraphie, Lviv, Ukraine, 2015.",
  adiosYear: "2016",
  ...
  carmenSubtitleFr: "Ballet en un acte · Bizet-Chtchedrine",
  carmenDescriptionEn: "Bizet’s immortal opera, reborn through Rodion Shchedrin’s 1967 orchestration for strings and percussion — written expressly for Maya Plisetskaya. Presented at the Lviv Opera choreographers’ competition.",
  ...
  carmenDescriptionFr: "L'opéra immortel de Bizet, réinventé à travers l'orchestration de Chtchedrine pour cordes et percussions (1967), écrite tout spécialement pour Maïa Plissetskaïa.",
  carmenYear: "2019",
  carmenMusic: "Georges Bizet / Rodion Shchedrin",
  theAntsVideo1En: "Part 1. Life awakens in the anthill. Dance of the Queen, the secret service, the princesses and the ordinary workers.",
  ...
  theAntsVideo2En: "Part 2. The Prince’s solo — the central character of the ballet.",
  theAntsVideo2Uk: "Частина 2. Соло принца, головного героя вистави.",
  theAntsVideo2Fr: "Partie 2. Solo du Prince, personnage principal du spectacle.",
  mozart25Video1En: "Stage workshop of the ballet’s choreography. Act One. Teaser.",
  mozart25Video1Uk: "Сценічна хореографічна розробка балету. Перший акт. Тизер.",
  mozart25Video1Fr: "Esquisse chorégraphique du ballet, sur scène. Premier acte. Teaser.",
  mozart25Video2En: "A longer, fuller version of the choreographic text.",
  mozart25Video2Uk: "Більш розлога, повна версія хореографічного тексту.",
  mozart25Video2Fr: "Une version plus longue et plus complète du texte chorégraphique.",
  adiosVideo1En: "1st Place · International Choreographers’ Competition, Lviv, 2015 · Theatre recording",
  adiosVideo1Uk: "1 місце · Міжнародний конкурс балетмейстерів, Львів, 2015 · Запис із театру",
  adiosVideo1Fr: "1re place · Concours international de chorégraphie, Lviv, 2015 · Captation au théâtre",
  adiosVideo2En: "Adios · Re-filmed in the studio, better quality",
  adiosVideo2Uk: "Адьос · Перезйомка в залі, краща якість",
  ...
  icareHeroLabelFr: "Création mondiale · 2026",
  icareHeroSubtitleEn: "After the score by Igor Markevitch, 1932", icareHeroSubtitleUk: "За партитурою Ігоря Маркевича, 1932",
  icareHeroSubtitleFr: "D'après la partition d'Igor Markevitch, 1932",
  icareHeroTaglineEn: "The first-ever staging of a ballet that waited ninety-three years to be brought to life.", icareHeroTaglineUk: "Перша в історії постановка балету, що 93 роки чекав хореографа.",
  icareHeroTaglineFr: "La toute première création scénique d'un ballet qui a attendu quatre-vingt-treize ans pour voir le jour.",
  icareMissionTitleEn: "93 years of waiting. A world premiere for our time.", icareMissionTitleUk: "93 роки очікування. Одна світова прем'єра.",
  icareMissionTitleFr: "93 ans d'attente. Une création mondiale pour notre temps.",
  icareMission1932En: "Igor Markevitch composed L'Envol d'Icare for the Paris Opéra, commissioned by Serge Lifar. Lifar admired the score — “The music was admirable, the idea of uniting it with dance seductive, but I had the clear sense that I would never manage to bring my rhythm into accord with Markevitch's” — and the premiere was put off for decades.", icareMission1932Uk: "Ігор Маркевич написав «Політ Ікара» в Парижі для трупи Дягілєва. Дягілєв помер у 1929-му — прем'єра відтерміновується назавжди.",
  icareMission1932Fr: "Igor Markevitch compose L'Envol d'Icare pour l'Opéra de Paris, à la demande de Serge Lifar. Lifar admire la partition — « La musique était admirable, l'idée de son union avec la danse séduisante, mais j'avais le net sentiment qu'il me serait impossible d'accorder mon rythme à celui de Markevitch » — et la création est repoussée pour des décennies.",
  icareMission93En: "Years of silence. The score waited for the stage. It was played in concert, by Markevitch and later by his pupils, but no choreographic version was ever staged.", icareMission93Uk: "Роки тиші. Партитура існувала. Концертні виконання були. Хореографічного тіла — не було.",
  icareMission93Fr: "Des années de silence. La partition attend la scène. Elle est jouée en concert, par Markevitch puis par ses élèves, mais aucune version chorégraphique ne voit jamais le jour.",
  icareMission2026En: "Artem Hordieiev creates the first full stage production of the work. The world premiere comes ninety-three years on.", icareMission2026Uk: "Артем Гордієв створює першу повноцінну постановку. Ensemble of Five виконує партитуру 1932 року. Світова прем'єра через 93 роки.",
  icareMission2026Fr: "Artem Hordieiev en signe aujourd'hui la première version scénique à part entière. Création mondiale, quatre-vingt-treize ans plus tard.",
  icareQuoteEn: "Icarus did not fall because he was careless or reckless. From the very start, he chose to fly — consciously.", icareQuoteUk: "Ікар не впав через помилку. Він вибрав летіти.",
  icareQuoteFr: "Icare n'est pas tombé par négligence ou par imprudence. Dès le début, il a choisi de voler, en pleine conscience.",
  ...
  icareConceptDescEn: "The production unfolds in three philosophical steps, which together form a stage language of its own.", icareConceptDescUk: "Вистава будується на перетині трьох культурних пластів, що разом утворюють власну хореографічну мову.",
  icareConceptDescFr: "Le spectacle se déploie en trois étapes philosophiques qui, ensemble, forment un langage scénique qui lui est propre.",
  ...
  icarePillar1DescFr: "Un événement de la vie n'est en lui-même ni positif ni négatif : il est neutre. Seule notre attitude lui donne un rôle, une couleur, une intention. C'est l'enseignement des stoïciens : la seule chose qui soit vraiment en notre pouvoir, c'est notre attitude face à ce qui arrive.",
  ...
  icarePillar2DescFr: "Le SOLEIL ouvre ses portes à un « nouvel » Icare du XXIe siècle, parce que celui-ci ne s'est pas arrêté : il a pris le défi tel qu'il est. Il a laissé le Soleil brûler et la Lune refroidir. Le corps comme instrument de la volonté : ni l'esprit, ni l'arme — c'est le corps lui-même qui ouvre la brèche. À la place de l'éternelle aspiration de l'humain vers l'impossible, l'accomplissement de l'impossible par l'humain, comme un choix conscient. Comme la résistance ukrainienne.",
  ...
  icarePillar3DescFr: "L'Icare de Matisse comme une iconographie radicalement autre. Non plus un humain qui vole vers le soleil, mais un humain qui EST le soleil. Ce pourrait être l'image finale du spectacle.",
  icareScoreSubtitleEn: "Igor Markevitch, Paris, 1932", icareScoreSubtitleUk: "Ігор Маркевич, Париж, 1932",
  ...
  icareDramaturgyTitleFr: "7 mouvements · 27 minutes",
  ...
  icareCtaTitleFr: "Disponible pour une création mondiale",
  icareCtaTextEn: "ICARE is open to conversations with theatres, festivals and producing organisations — the key partners for its first staging anywhere in the world.", icareCtaTextUk: "ICARE відкрита для переговорів з театрами, фестивалями та продюсерськими організаціями — виключний партнер для першої постановки у світі.",
  icareCtaTextFr: "Le projet ICARE est ouvert aux discussions avec les théâtres, les festivals et les structures de production : les partenaires clés de sa création mondiale.",
  icareCtaBtnEn: "Contact the choreographer", icareCtaBtnUk: "Написати хореографу",
  ...
  theAntsPremiereTitleFr: "Disponible en coproduction",
  theAntsPremiereTextEn: "The Ants is available for international co-production, festival presentation and touring. Get in touch to discuss a collaboration.", theAntsPremiereTextUk: "«Мурахи» доступні для міжнародної копродукції, фестивального показу та гастролей. Зв'яжіться з нами, щоб обговорити співпрацю.",
  theAntsPremiereTextFr: "Les Fourmis sont disponibles en coproduction internationale, en programmation de festival et en tournée. Contactez-nous pour en parler.",
  theAntsPremiereBtnEn: "Book this production", theAntsPremiereBtnUk: "Замовити виставу",
  theAntsPremiereBtnFr: "Programmer le spectacle",
  ...
  mozart25PremiereTextEn: "Mozart 25 is available for festival presentation, international touring and co-production. Get in touch to discuss programming.", mozart25PremiereTextUk: "«Моцарт 25» доступний для фестивального показу, міжнародних гастролей та копродукції. Зв'яжіться з нами для обговорення програмування.",
  mozart25PremiereTextFr: "Mozart 25 est disponible pour une programmation en festival, une tournée internationale et une coproduction. Contactez-nous pour en parler.",
  mozart25PremiereBtnEn: "Book this production", mozart25PremiereBtnUk: "Замовити виставу",
  mozart25PremiereBtnFr: "Programmer le spectacle",
  ...
  carmenPremiereTextEn: "Carmen (Bizet–Shchedrin) is available for festival presentation, competition and international touring. Get in touch to discuss programming.", carmenPremiereTextUk: "«Кармен» (Бізе–Щедрін) доступна для фестивального показу, конкурсу та міжнародних гастролей. Зв'яжіться для обговорення.",
  carmenPremiereTextFr: "Carmen (Bizet–Chtchedrine) est disponible pour une programmation en festival et en coproduction internationale. Contactez-nous pour en parler.",
  carmenPremiereBtnEn: "Book this production", carmenPremiereBtnUk: "Замовити виставу",
  carmenPremiereBtnFr: "Programmer le spectacle",
  ...
  mercyHeroTaglineFr: "Né du confinement. Dansé au mépris des règles. Une méditation sur la miséricorde, la liberté et la fine frontière qui les sépare.",
  ...
  mercyIntroBodyFr: "La pandémie a divisé le ballet de Lviv en sept groupes isolés de cinq à six danseurs. Le travail d'ensemble est devenu impossible. Errant dans un Kyiv désert, le chorégraphe s'est heurté au paradoxe de la condition humaine : des citadins enfermés dans leurs appartements, et le silence absolu des rues. Cette sensation est devenue une vision. À ses propres frais, sans soutien institutionnel, il est parti à Lviv et a créé Mercy — une petite pièce qui a hissé des danseurs du corps de ballet au rang de premiers solistes lors du concours de promotion. Cette danse est un manifeste de ce qui survit quand presque tout a été retiré à un être humain.",
  ...
  mercyContextBodyFr: "Chorégraphie sur la musique de Max Richter, tirée de l'album Voices (2020). L'œuvre s'inspire de la lecture historique de la Déclaration universelle des droits de l'homme par Eleanor Roosevelt, en 1948. La Déclaration, à son tour, puise dans le Pacte Roerich — le premier traité international protégeant les biens culturels en cas de conflit armé, signé à Washington en 1935. Un ballet né de l'isolement de la pandémie, porté par une musique sur les droits humains, elle-même enracinée dans un traité qui plaçait la culture au-dessus de la nécessité militaire. Un projet qui peut prendre l'échelle d'une grande scène.",
  mercyVideo1Id: "",
  ...
  mercyCtaTextEn: "Mercy is in the phase of conceptual and choreographic development. Producing partners interested in a full-scale production are welcome to get in touch. The artistic foundation exists. The scale is available.",
  ...
  mercyCtaTextFr: "Mercy est en phase de développement conceptuel et chorégraphique. Les partenaires de production intéressés par une production à grande échelle sont invités à nous contacter.",
  ...
  humansIntroBodyFr: "Humans est l'un des chapitres d'un cycle sacré enraciné dans l'héritage philosophique de Nicolas Roerich — peintre, penseur et initiateur du Pacte Roerich. Le spectacle poursuit une recherche chorégraphique sur les rituels mystiques archaïques, antérieurs à la civilisation écrite. En résonance avec Le Sacre du printemps de Stravinsky et Roerich, il se tourne vers l'éveil de la nature, les origines de la conscience et ce premier instant où le corps est devenu un instrument du rituel. Le spectateur plonge dans un monde hypothétique où les humains ne naissent pas : on les crée. Non pas des dieux au sens théologique, mais des Parents cosmiques, des êtres d'une autre dimension dont la danse rituelle est l'acte même de la création.",
  ...
  humansMythBodyEn: "The Cosmic Parents appear. Their bodies re-enact an ancient ritual: the awakening of matter, the moulding of form, the ignition of consciousness. From their movement a human being is born — unfinished, dependent, full of fear and, at the same time, of unrealised potential. Then the creators leave their creation and return to their own dimension. The created being is left alone on Earth: to find language, to set rules, and to build a civilisation from nothing.",
  ...
  humansMythBodyFr: "Les Parents cosmiques apparaissent. Leurs corps rejouent un rituel archaïque : l'éveil de la matière, le modelage de la forme, l'embrasement de la conscience. De leur mouvement naît l'être humain — inachevé, dépendant, plein de peur et, en même temps, d'un potentiel encore inexploré. Puis les créateurs abandonnent leur créature et regagnent leur dimension d'origine. L'être créé reste seul sur Terre : trouver le langage, poser des règles, bâtir une civilisation à partir de rien.",
  humansVideo1Id: "",
  ...
  humansCtaTextEn: "Humans is in active development as part of a larger trilogy on Roerich’s cosmogony. Producing partners and festival presenters are welcome to open a conversation about its future staging.",
  ...
  humansCtaTextFr: "Humans est en développement actif, comme volet d'une trilogie plus vaste consacrée à la cosmogonie de Roerich. Partenaires de production et programmateurs de festivals sont invités à ouvrir le dialogue sur sa future création.",
