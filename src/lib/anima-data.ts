export const animaData = {
  premiere: {
    date: "April 12, 2014",
    dateUk: "12 квітня 2014",
    dateFr: "12 avril 2014",
    venue: {
      en: "Kyiv Municipal Academic Theatre of Opera and Ballet for Children and Youth (KMATOB)",
      uk: "Київський муніципальний академічний театр опери і балету для дітей та юнацтва (КМАТОБ)",
      fr: "Théâtre académique municipal d'opéra et de ballet pour enfants et jeunesse de Kyiv (KMATOB)",
    },
    event: {
  ...
  credits: {
    idea: { name: "Tetiana Khyzhniak", nameUk: "Тетяна Хижняк", nameFr: "Tetiana Khyzhniak" },
    choreography: { name: "Artem Hordieiev", nameUk: "Артем Гордєєв", nameFr: "Artem Hordieiev" },
    music: "L'Orchestre de Contrebasses (Marseille, France)",
    costumes: { name: "Jenia Kirienko", nameUk: "Женя Кирієнко", nameFr: "Jenia Kirienko" },
    company: "LITSO Dance Company",
  },
  ...
  cast: [
    ...
    },
    {
      ...
      name: { en: "Mariia Deli", uk: "Марія Делі" },
      photo: null,
    },
    {
    ...
    {
      role: { en: "Illusions of Reality", uk: "Ілюзії реальності" },
      name: { en: "Andrii Ulianenko", uk: "Андрій Ульяненко" },
      photo: null,
    },
  ],
  ...
  scenes: [
    ...
    },
    {
      ...
      arcanaUk: "Смерть",
      arcanaFr: "La Mort",
      image: "/images/works/anima/death.jpg",
      description: {
        en: "The way forward, far beyond the boundaries, a total transformation.",
        uk: "Шлях уперед, далеко за межі, повна трансформація.",
        fr: "Le chemin en avant, bien au-delà des frontières, une transformation totale.",
      },
    },
    {
      number: 7,
      arcana: "Temperance",
      arcanaUk: "Поміркованість",
      arcanaFr: "Tempérance",
      image: "/images/works/anima/temperance.jpg",
      description: {
        en: "All the previous transformations lead to temperance and balance.",
        uk: "Усі попередні трансформації ведуть до поміркованості та рівноваги.",
        fr: "Toutes les transformations précédentes mènent à la tempérance et à l'équilibre.",
      },
    },
  ],
  ...
  videos: {
    ...
    rehearsal: {
      id: "ks-RzvaKsNQ",
      title: { en: "ANIMA — Rehearsal", uk: "АНІМА — Репетиція", fr: "ANIMA — Répétition" },
    },
  },
  ...
  festival: {
    ...
    venue: {
      en: "Kyiv Municipal Academic Theatre of Opera and Ballet for Children and Youth, 2 Mezhyhirska St., Kyiv (metro Kontraktova Ploshcha)",
      uk: "Київський муніципальний академічний театр опери і балету для дітей та юнацтва, вул. Межигірська, 2, Київ (м. Контрактова площа)",
      fr: "Théâtre académique municipal d'opéra et de ballet pour enfants et jeunesse de Kyiv, 2 rue Mejyhirska, Kyiv (métro Kontraktova Ploshcha)",
    },
    organizers: {
      en: "Organized by Oleksii Busko (leading soloist of Kyiv Modern-Ballet, 2012–2022; artistic director of KMATOB-FEST, 2014–2017) with the support of Radu Poklitaru and KMATOB.",
      uk: "Організатор: Олексій Бусько (провідний соліст «Київ Модерн-Балет», 2012–2022; художній керівник КМАТОБ-ФЕСТ, 2014–2017) за підтримки Раду Поклітару та КМАТОБ.",
      fr: "Organisé par Oleksii Busko (soliste principal du Kyiv Modern-Ballet, 2012–2022 ; directeur artistique du KMATOB-FEST, 2014–2017) avec le soutien de Radu Poklitaru et du KMATOB.",
    },
    ...
    masterclasses: {
      en: [
        "April 7, 11:30–13:00 — LITSO Dance Company: Creative laboratory of contemporary dance (Artem Hordieiev, Olena Dovhikh)",
        "April 8, 14:30–16:00 — LITSO Dance Company: Training on perception of space, movement and body (Artem Hordieiev, Olena Dovhikh)",
        "April 9, 14:30–16:00 — LITSO Dance Company: Training on development of imagination in plastic improvisation (Artem Hordieiev, Olena Dovhikh)",
        "April 10, 14:30–16:00 — LITSO Dance Company: Creating dance based on previous training (Artem Hordieiev, Olena Dovhikh)",
      ],
      uk: [
        "7 квітня, 11:30–13:00 — LITSO Dance Company: Авторська лабораторія сучасного танцю (Артем Гордєєв, Олена Довгіх)",
        "8 квітня, 14:30–16:00 — LITSO Dance Company: Тренінг зі сприйняття простору, руху і тіла (Артем Гордєєв, Олена Довгіх)",
        "9 квітня, 14:30–16:00 — LITSO Dance Company: Тренінг з розвитку уяви в пластичній імпровізації (Артем Гордєєв, Олена Довгіх)",
        "10 квітня, 14:30–16:00 — LITSO Dance Company: Створення танцю на основі попередніх тренінгів (Артем Гордєєв, Олена Довгіх)",
      ],
    },
  },

  litsoCompany: {
    en: "LITSO Dance Company was founded in 2013 by students of the Karpenko-Karyi Kyiv National University of Theatre, Film and Television. The name \"LITSO\" (Ukrainian for \"face\") reflected the company's core mission: to explore the theatre as a space where the true face of humanity is revealed through dance and dramaturgy. LITSO served as a creative laboratory — a place for research at the intersection of contemporary dance, physical theatre, and choreographic storytelling. Newspaper Birds Ballet (NBB) is its natural professional evolution: from an experimental student laboratory into a fully-fledged contemporary ballet company operating on the European stage.",
    uk: "LITSO Dance Company була заснована у 2013 році студентами Київського національного університету театру, кіно і телебачення імені Карпенка-Карого. Назва «ЛІТСО» (обличчя) відображала головну місію компанії: досліджувати театр як простір, де через танець та драматургію розкривається справжнє обличчя людства. LITSO була творчою лабораторією — місцем для досліджень на перетині сучасного танцю, фізичного театру та хореографічної оповіді. Newspaper Birds Ballet (NBB) — це її природне професійне продовження: від експериментальної студентської лабораторії до повноцінної сучасної балетної компанії, що працює на європейській сцені.",
    fr: "LITSO Dance Company a été fondée en 2013 par des étudiants de l'Université nationale du théâtre, du cinéma et de la télévision Karpenko-Kary de Kyiv. Le nom « LITSO » (qui signifie « visage » en ukrainien) reflétait la mission fondatrice de la compagnie : explorer le théâtre comme un espace où le vrai visage de l'humanité se révèle par la danse et la dramaturgie. LITSO fonctionnait comme un laboratoire créatif — un lieu de recherche à la croisée de la danse contemporaine, du théâtre physique et de la narration chorégraphique. Newspaper Birds Ballet (NBB) en est le prolongement professionnel naturel : d'un laboratoire expérimental étudiant à une compagnie de ballet contemporain à part entière, active sur la scène européenne.",
  },
};
