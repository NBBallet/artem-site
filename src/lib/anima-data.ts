export const animaData = {
  ...
  credits: {
    idea: { name: "Tetiana Khyzhniak", nameUk: "Тетяна Хижняк" },
    choreography: { name: "Artem Hordieiev", nameUk: "Артем Гордєєв" },
    music: "L'Orchestre de Contrebasses (Marseille, France)",
    costumes: { name: "Jenia Kirienko", nameUk: "Женя Кирієнко" },
  ...
  videos: {
    showreel: {
      id: "ATM9z-LrIA0",
      title: { en: "ANIMA — Showreel (6 min)", uk: "АНІМА — Шоуріл (6 хв)" },
    },
    premiere: {
      id: "OtBzaz8hSGM",
      title: { en: "ANIMA — Full Premiere Recording", uk: "АНІМА — Повний запис прем'єри" },
    },
    rehearsal: {
      id: "ks-RzvaKsNQ",
      title: { en: "ANIMA — Rehearsal", uk: "АНІМА — Репетиція" },
    },
  },
